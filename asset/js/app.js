...
const translations = {
    'en': {
        ...
        // Portal
        'donate_offer': 'Offer Your Devotion', 'donate_title': 'Spiritual Donation Center', 'donate_label': 'Gau Mata Sanrakshan',
        ...
        // About Page
        'about_hero_span': 'Built with Love for Cows',
        'about_hero_h1': 'Our <span class="italic text-gold">History & Mission</span>',
        'about_mission_quote': 'Where every life is respected, and every heartbeat tells a story of <span class="text-saffron">love and kindness</span>. We are here to protect them.',
        'about_mission_label': '— Our Thinking',
        'about_years_exp': 'Years of Constant Service',
        'about_journey_label': 'Our Story',
        'about_journey_title': 'Based on <span class="italic text-gold">Old Values</span>, Ready for the Future',
        'about_journey_p1': 'Shri Gau Rakshak Seva Samiti started in Galpadar, Gandhidham, as a small home for cows. What began with just three saved cows has now become a large, modern safe home, mixing old wisdom with new farming ways.',
        'about_journey_p2': 'We do more than just give them a roof; we want to make the Kutch area a place where humans and cows live happily together again, making sure no cow is left alone or in pain.',
    ...
    'hi': {
        ...
        'donate_offer': 'अपनी श्रद्धा अर्पित करें', 'donate_title': 'दान सेवा केंद्र', 'donate_label': 'गૌ માતા સંરક્ષણ',
        'donate_desc': 'शहर की कठिन सड़कों से हमारे अभयारण्य की अनंत शांति तक—हर सुधार आपकी लिखी एक कहानी है।',
        'donate_subtitle': 'दिव्य सेवा केंद्र', 'form_seva_label': 'सेवा चुनें', 'form_amount_label': 'राशि (₹)',
        'form_id_label': 'पावन पहचान', 'form_birthday_label': 'जन्मदिन अनुष्ठान', 'form_select_opt': 'क्षेत्र चुनें',
        'currency_inr': 'भारतीय रुपया (INR)', 'currency_foreign': 'विदेशी मुद्रा',
        'form_pincode': 'शहर का पिनकोड', 'form_submit': 'सेवा का दान करें',
        'placeholder_pincode': 'पिनकोड', 'placeholder_amount': '₹ राशि', 'placeholder_phone': 'व्हाट्सएप नंबर', 'placeholder_ritual': 'जन्मदिन अनुष्ठान',
        'donate_verify_label': 'सत्यापन विवरण', 'donate_upi_label': 'सीधा UPI माध्यम', 'donate_trust_label': 'अभयारण्य ट्रस्ट', 'donate_tax_label': 'धारा 80G के तहत टैक्स छूट - आयकर अधिनियम 1961',
        'testimonials_label': 'जुड़े हुए लोगों की बातें', 'testimonials_title': 'भक्त क्या कहते हैं',
        'testi1_n': 'राजेश शर्मा', 'testi1_r': 'हर महीने दान देने वाले', 'testi1_t': 'गौशाला आकर मेरा नजरिया बदल गया। बीमार गायों की देखभाल यहाँ बहुत अच्छी तरह की जाती है।', 'testi1_initial': 'र',
        'testi2_n': 'प्रिया पटेल', 'testi2_r': 'स्वयंसेवक', 'testi2_t': 'यहाँ सब कुछ साफ और स्पष्ट है। मुझे पता है कि मेरा छोटा सा दान सही काम में लग रहा है।', 'testi2_initial': 'प्र',
        'testi3_n': 'अमित वर्मा', 'testi3_r': 'आगंतुक', 'testi3_t': 'सच्चा आध्यात्मिक अनुभव! वेबसाइट पर 360° टूर अच्छा है, पर यहाँ आकर सेवा करना सुकून देता है।', 'testi3_initial': 'अ',
        'testi4_n': 'मीरा बाई', 'testi4_r': 'दाता', 'testi4_t': 'यहाँ का अस्पताल और आईसीयू बहुत अच्छा है। गायों के प्रति इतना प्यार देखकर मन खुश हो जाता है।', 'testi4_initial': 'म',
        ...
        // About Page (Hindi)
        'about_hero_span': 'गौ माता के प्यार से निर्मित',
        'about_hero_h1': 'हमारा <span class="italic text-gold">इतिहास और लक्ष्य</span>',
        'about_mission_quote': 'जहाँ हर जीवन का सम्मान है, और हर धड़कन <span class="text-saffron">प्यार और दया</span> की कहानी कहती है। हम गौ रक्षक हैं।',
        'about_mission_label': '— हमारी सोच',
        'about_years_exp': 'लगातार सेवा के वर्ष',
        'about_journey_label': 'हमारी कहानी',
        'about_journey_title': '<span class="italic text-gold">पुराने मूल्यों</span> पर आधारित, भविष्य के लिए तैयार',
        'about_journey_p1': 'गलपादर, गांधीधाम में स्थित, हमारी संस्था (श्री गौ रक्षक सेवा समिति) एक छोटे से घर के रूप में शुरू हुई थी। तीन बची गायों से जो शुरू हुआ, वह अब एक बड़ा सुरक्षित घर बन गया है।',
        'about_journey_p2': 'हमारा लक्ष्य सिर्फ छत देना नहीं है; हम कच्छ क्षेत्र में ऐसा माहौल बनाना चाहते हैं जहाँ इंसान और गाय फिर से खुशी से साथ रहें, और कोई गाय अकेले या दर्द में न रहे।',
        ...
        'gallery_section_label': 'गौशाला गैलरी', 'gallery_section_title': 'पवित्र <span class="italic text-gold">शांति</span> की झलक',
        // Events Page
